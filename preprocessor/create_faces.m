function [inner_faces_adj,bound_faces_adj, bound_faces_flag, ...
 ...
 element_face_adj] = create_faces(elem_adj, coord, element_centroid, ...
                                                    boundary_flag_ref)
%function [bedge,inedge] = create_faces(elem_adj,bedgeref)
...
[bound_faces_normal_area] = guide_normals(upstream_bound_neigh, ...
   bound_faces_normal_area,bound_faces_centroid,element_centroid);
[inner_faces_normal_area] = guide_normals(inner_faces_neigh, ...
   inner_faces_normal_area,inner_faces_centroid,element_centroid);
[element_face_adj,~] = find(face_element_adj');
