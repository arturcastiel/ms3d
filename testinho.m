...
% nomemalha = sprintf('cubosimplesregular_%u.msh',malha);
% nomemalha = sprintf('cubodeyang_%u.msh',malha);
...
% nomemalha = sprintf('oblique-fracture_%u.msh',malha);
nomemalha = sprintf('casca2bandas_%u.msh',malha);
